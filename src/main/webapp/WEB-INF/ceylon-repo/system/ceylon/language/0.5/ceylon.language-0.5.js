    ...
    if (Tuple.$$===undefined){
        ...
        (function($$tuple){
            ...
            $$tuple.get=function get(index$223){
                ...
                var case$224=index$223.compare((0));
                if (case$224===getSmaller()) {
                    return null;
                }else if (case$224===getEqual()) {
                    return $$tuple.getFirst();
                }else if (case$224===getLarger()) {
    ...
    if (Range.$$===undefined){
        ...
        (function($$range){
            ...
            $$range.getRest=function getRest(){
                ...
                $init$RangeIterator$282();
                return RangeIterator$282();
            };$$range.by=function by(step$288){
                var $$range=this;
                //assert at Range.ceylon (112:8-113:25)
                if (!(step$288.compare((0)).equals(getLarger()))) { throw AssertionException('step size must be greater than zero: \'step > 0\' at Range.ceylon (113:15-113:24)'); }
                if(step$288.equals((1))){
                    return $$range;
                }
                var first$289;
                var last$290;
                if(isOfType((first$289=$$range.getFirst()),{t:Integer})&&isOfType((last$290=$$range.getLast()),{t:Integer})){
                    return integerRangeByIterable($$range,step$288,{Element:$$range.$$targs$$.Element});
                }
                return $$range.getT$all()['ceylon.language::Iterable'].$$.prototype.by.call(this,step$288);
            };$$range.contains=function contains(element$291){
                var $$range=this;
                var it$292 = $$range.getIterator();
                var e$293;while ((e$293=it$292.next())!==getFinished()){
                    if(e$293.equals(element$291)){
                        return true;
                    }
                }
                if (getFinished() === e$293){
                    return false;
                }
            };$$range.count=function count(selecting$294){
                var $$range=this;
                var e$295=$$range.getFirst();
                var setE$295=function(e$296){return e$295=e$296;};
                var c$297=(0);
                var setC$297=function(c$298){return c$297=c$298;};
                while($$range.includes(e$295)){
                    if(selecting$294(e$295)){
                        (oldc$299=c$297,c$297=oldc$299.getSuccessor(),oldc$299);
                        var oldc$299;
                    }
                    e$295=$$range.next$265(e$295);
                }
                return c$297;
            };$$range.includes=function (x$300){
                var $$range=this;
                return (opt$301=($$range.getDecreasing()?((x$300.compare($$range.getFirst())!==getLarger())&&(x$300.compare($$range.getLast())!==getSmaller())):null),opt$301!==null?opt$301:((x$300.compare($$range.getFirst())!==getSmaller())&&(x$300.compare($$range.getLast())!==getLarger())));
            };
            $$range.getClone=function getClone(){
                var $$range=this;
                return $$range;
            };
            $$range.segment=function segment(from$302,length$303){
                var $$range=this;
                if(((length$303.compare((0))!==getLarger())||from$302.compare($$range.getLastIndex()).equals(getLarger()))){
                    return getEmpty();
                }
                var x$304=$$range.getFirst();
                var setX$304=function(x$305){return x$304=x$305;};
                var i$306=(0);
                var setI$306=function(i$307){return i$306=i$307;};
                while((oldi$308=i$306,i$306=oldi$308.getSuccessor(),oldi$308).compare(from$302).equals(getSmaller())){
                    x$304=$$range.next$265(x$304);
                }
                var oldi$308;
                var y$309=x$304;
                var setY$309=function(y$310){return y$309=y$310;};
                var j$311=(1);
                var setJ$311=function(j$312){return j$311=j$312;};
                while(((oldj$313=j$311,j$311=oldj$313.getSuccessor(),oldj$313).compare(length$303).equals(getSmaller())&&y$309.compare($$range.getLast()).equals(getSmaller()))){
                    y$309=$$range.next$265(y$309);
                }
                var oldj$313;
                return Range(x$304,y$309,{Element:$$range.$$targs$$.Element});
            };$$range.span=function span(from$314,to$315){
                var $$range=this;
                var toIndex$316=to$315;
                var setToIndex$316=function(toIndex$317){return toIndex$316=toIndex$317;};
                var fromIndex$318=from$314;
                var setFromIndex$318=function(fromIndex$319){return fromIndex$318=fromIndex$319;};
                if(toIndex$316.compare((0)).equals(getSmaller())){
                    if(fromIndex$318.compare((0)).equals(getSmaller())){
                        return getEmpty();
                    }
                    toIndex$316=(0);
                }else {
                    if(toIndex$316.compare($$range.getLastIndex()).equals(getLarger())){
                        if(fromIndex$318.compare($$range.getLastIndex()).equals(getLarger())){
                            return getEmpty();
                        }
                        toIndex$316=$$range.getLastIndex();
                    }
                }
                if(fromIndex$318.compare((0)).equals(getSmaller())){
                    fromIndex$318=(0);
                    ...
                    if(fromIndex$318.compare($$range.getLastIndex()).equals(getLarger())){
                        fromIndex$318=$$range.getLastIndex();
                    }
                }
                var x$320=$$range.getFirst();
                var setX$320=function(x$321){return x$320=x$321;};
                var i$322=(0);
                var setI$322=function(i$323){return i$322=i$323;};
                while((oldi$324=i$322,i$322=oldi$324.getSuccessor(),oldi$324).compare(fromIndex$318).equals(getSmaller())){
                    x$320=$$range.next$265(x$320);
                }
                var oldi$324;
                var y$325=$$range.getFirst();
                var setY$325=function(y$326){return y$325=y$326;};
                var j$327=(0);
                var setJ$327=function(j$328){return j$327=j$328;};
                while((oldj$329=j$327,j$327=oldj$329.getSuccessor(),oldj$329).compare(toIndex$316).equals(getSmaller())){
                    y$325=$$range.next$265(y$325);
                }
                var oldj$329;
                return Range(x$320,y$325,{Element:$$range.$$targs$$.Element});
            };$$range.spanTo=function spanTo(to$330){
                var $$range=this;
                return (opt$331=(to$330.compare((0)).equals(getSmaller())?getEmpty():null),opt$331!==null?opt$331:$$range.span((0),to$330));
                var opt$331;
            };$$range.spanFrom=function spanFrom(from$332){
                var $$range=this;
                return $$range.span(from$332,$$range.getSize());
            };$$range.getReversed=function getReversed(){
                var $$range=this;
                return Range($$range.getLast(),$$range.getFirst(),{Element:$$range.$$targs$$.Element});
            };
            $$range.skipping=function skipping(skip$333){
                var $$range=this;
                var x$334=(0);
                var setX$334=function(x$335){return x$334=x$335;};
                var e$336=$$range.getFirst();
                var setE$336=function(e$337){return e$336=e$337;};
                while((oldx$338=x$334,x$334=oldx$338.getSuccessor(),oldx$338).compare(skip$333).equals(getSmaller())){
                    e$336=$$range.next$265(e$336);
                }
                var oldx$338;
                return (opt$339=($$range.includes(e$336)?Range(e$336,$$range.getLast(),{Element:$$range.$$targs$$.Element}):null),opt$339!==null?opt$339:getEmpty());
                var opt$339;
            };$$range.taking=function taking(take$340){
                var $$range=this;
                if(take$340.equals((0))){
                    return getEmpty();
                }
                var x$341=(0);
                var setX$341=function(x$342){return x$341=x$342;};
                var e$343=$$range.getFirst();
                var setE$343=function(e$344){return e$343=e$344;};
                while((x$341=x$341.getSuccessor()).compare(take$340).equals(getSmaller())){
                    e$343=$$range.next$265(e$343);
                }
                return (opt$345=($$range.includes(e$343)?Range($$range.getFirst(),e$343,{Element:$$range.$$targs$$.Element}):null),opt$345!==null?opt$345:$$range);
                var opt$345;
...
function $init$Set(){
    if (Set.$$===undefined){
        ...
        (function($$set){
            $$set.superset=function superset(set$346){
                var $$set=this;
                var it$347 = set$346.getIterator();
                var element$348;while ((element$348=it$347.next())!==getFinished()){
                    if((!$$set.contains(element$348))){
                        return false;
                    }
                }
            ...
            };$$set.subset=function subset(set$349){
                var $$set=this;
                var it$350 = $$set.getIterator();
                var element$351;while ((element$351=it$350.next())!==getFinished()){
                    if((!set$349.contains(element$351))){
                        return false;
                    }
                }
                if (getFinished() === element$351){
                    return true;
                }
            };$$set.equals=function equals(that$352){
                var $$set=this;
                var that$353;
                if(isOfType((that$353=that$352),{t:Set,a:{Element:{t:Object$}}})&&that$353.getSize().equals($$set.getSize())){
                    var it$354 = $$set.getIterator();
                    var element$355;while ((element$355=it$354.next())!==getFinished()){
                        if((!that$353.contains(element$355))){
                            return false;
                        }
                    }
                    if (getFinished() === element$355){
                        return true;
                    }
                }
                return false;
                ...
                var $$set=this;
                var hashCode$356=(1);
                var setHashCode$356=function(hashCode$357){return hashCode$356=hashCode$357;};
                var it$358 = $$set.getIterator();
                var elem$359;while ((elem$359=it$358.next())!==getFinished()){
                    (hashCode$356=hashCode$356.times((31)));
                    (hashCode$356=hashCode$356.plus(elem$359.getHash()));
                }
                return hashCode$356;
            };
        })(Set.$$.prototype);
        ...
        (function($$singleton){
            ...
            $$singleton.getIterator=function getIterator(){
                ...
                function SingletonIterator$362($$singletonIterator$362){
                    ...
                    $$singletonIterator$362.done$363=false;
                ...
                function $init$SingletonIterator$362(){
                    if (SingletonIterator$362.$$===undefined){
                        ...
                        (function($$singletonIterator$362){
                            $$singletonIterator$362.getDone$363=function getDone$363(){
                                return this.done$363;
                            };
                            $$singletonIterator$362.setDone$363=function setDone$363(done$364){
                                return this.done$363=done$364;
                            };
                            $$singletonIterator$362.next=function next(){
                                var $$singletonIterator$362=this;
                                if($$singletonIterator$362.getDone$363()){
                                    return getFinished();
                                }else {
                                    $$singletonIterator$362.setDone$363(true);
                                    return $$singleton.element$360;
                                }
                            };$$singletonIterator$362.getString=function getString(){
                                var $$singletonIterator$362=this;
            ...
            $$singleton.equals=function equals(that$375){
                ...
                if(isOfType((that$376=that$375),{t:List,a:{Element:{t:Anything}}})){
                    if(that$376.getSize().equals((1))){
                        var elem$377;
                        if((elem$377=that$376.getFirst())!==null){
                ...
                var $$singleton=this;
                return (31).plus($$singleton.element$360.getHash());
            };
    ...
    if (LazyList.$$===undefined){
        ...
        (function($$lazyList){
            $$lazyList.getLastIndex=function getLastIndex(){
                var $$lazyList=this;
                var size$396=$$lazyList.elems$395.getSize();
                return (opt$397=(size$396.compare((0)).equals(getLarger())?size$396.minus((1)):null),opt$397!==null?opt$397:null);
                var opt$397;
            };$$lazyList.get=function get(index$398){
                var $$lazyList=this;
                if(index$398.equals((0))){
                    return $$lazyList.elems$395.getFirst();
                }else {
                    return $$lazyList.elems$395.skipping(index$398).getFirst();
                }
            };$$lazyList.getIterator=function getIterator(){
                var $$lazyList=this;
                return $$lazyList.elems$395.getIterator();
            };
            $$lazyList.getReversed=function getReversed(){
                var $$lazyList=this;
                return $$lazyList.elems$395.getSequence().getReversed();
            };
            $$lazyList.getClone=function getClone(){
                var $$lazyList=this;
                return $$lazyList;
            };
            $$lazyList.span=function span(from$399,to$400){
                var $$lazyList=this;
                if((to$400.compare((0)).equals(getSmaller())&&from$399.compare((0)).equals(getSmaller()))){
                    return getEmpty();
                }
                var toIndex$401=largest(to$400,(0),{Element:{t:Integer}});
                var fromIndex$402=largest(from$399,(0),{Element:{t:Integer}});
                if((toIndex$401.compare(fromIndex$402)!==getSmaller())){
                    var els$403=(opt$404=(fromIndex$402.compare((0)).equals(getLarger())?$$lazyList.elems$395.skipping(fromIndex$402):null),opt$404!==null?opt$404:$$lazyList.elems$395);
                    var opt$404;
                    return LazyList(els$403.taking(toIndex$401.minus(fromIndex$402).plus((1))),{Element:$$lazyList.$$targs$$.Element});
                }else {
                    var seq$405=(opt$406=(toIndex$401.compare((0)).equals(getLarger())?$$lazyList.elems$395.skipping(toIndex$401):null),opt$406!==null?opt$406:$$lazyList.elems$395);
                    var opt$406;
                    return seq$405.taking(fromIndex$402.minus(toIndex$401).plus((1))).getSequence().getReversed();
                }
            };$$lazyList.spanTo=function (to$407){
                var $$lazyList=this;
                return (opt$408=(to$407.compare((0)).equals(getSmaller())?getEmpty():null),opt$408!==null?opt$408:LazyList($$lazyList.elems$395.taking(to$407.plus((1))),{Element:$$lazyList.$$targs$$.Element}));
            };
            $$lazyList.spanFrom=function (from$409){
                var $$lazyList=this;
                return (opt$410=(from$409.compare((0)).equals(getLarger())?LazyList($$lazyList.elems$395.skipping(from$409),{Element:$$lazyList.$$targs$$.Element}):null),opt$410!==null?opt$410:$$lazyList);
            };
            $$lazyList.segment=function segment(from$411,length$412){
                var $$lazyList=this;
                if(length$412.compare((0)).equals(getLarger())){
                    var els$413=(opt$414=(from$411.compare((0)).equals(getLarger())?$$lazyList.elems$395.skipping(from$411):null),opt$414!==null?opt$414:$$lazyList.elems$395);
                    var opt$414;
                    return LazyList(els$413.taking(length$412),{Element:$$lazyList.$$targs$$.Element});
                }else {
                    return getEmpty();
                }
            };$$lazyList.equals=function equals(that$415){
                var $$lazyList=this;
                var that$416;
                if(isOfType((that$416=that$415),{t:List,a:{Element:{t:Anything}}})){
                    var size$417=$$lazyList.elems$395.getSize();
                    if(that$416.getSize().equals(size$417)){
                        var it$418 = Range((0),size$417.minus((1)),{Element:{t:Integer}}).getIterator();
                        var i$419;while ((i$419=it$418.next())!==getFinished()){
                            var x$420=$$lazyList.get(i$419);
                            var y$421=that$416.get(i$419);
                            var x$422;
                            if((x$422=x$420)!==null){
                                var y$423;
                                if((y$423=y$421)!==null){
                                    if((!x$422.equals(y$423))){
                                        return false;
                                    }
                                }else {
                                    return false;
                ...
                var $$lazyList=this;
                var hash$425=(1);
                var setHash$425=function(hash$426){return hash$425=hash$426;};
                var it$427 = $$lazyList.elems$395.getIterator();
                var elem$428;while ((elem$428=it$427.next())!==getFinished()){
                    (hash$425=hash$425.times((31)));
                    var elem$429;
                    if((elem$429=elem$428)!==null){
                        (hash$425=hash$425.plus(elem$429.getHash()));
                    }
                }
                return hash$425;
            };$$lazyList.findLast=function (selecting$430){
                var $$lazyList=this;
                return $$lazyList.elems$395.findLast(selecting$430);
            };
            ...
            $$lazyList.getLast=function getLast(){
                var $$lazyList=this;
                return $$lazyList.elems$395.getLast();
            };
        })(LazyList.$$.prototype);
    }
    return LazyList;
...
$init$LazyList();
var opt$408,opt$410;
function LazyMap(entries$431, $$targs$$,$$lazyMap){
    $init$LazyMap();
    if ($$lazyMap===undefined)$$lazyMap=new LazyMap.$$;
    set_type_args($$lazyMap,$$targs$$);
    $$lazyMap.entries$431=entries$431;
    Map($$lazyMap);
    return $$lazyMap;
}
    ...
    if (LazyMap.$$===undefined){
        ...
        (function($$lazyMap){
            $$lazyMap.getFirst=function getFirst(){
                var $$lazyMap=this;
                return $$lazyMap.entries$431.getFirst();
            };
            $$lazyMap.getLast=function getLast(){
                var $$lazyMap=this;
                return $$lazyMap.entries$431.getLast();
            };
            ...
            $$lazyMap.getSize=function getSize(){
                var $$lazyMap=this;
                return $$lazyMap.entries$431.getSize();
            };
            $$lazyMap.get=function (key$432){
                var $$lazyMap=this;
                return (opt$433=$$lazyMap.entries$431.find(function (e$434){
                    var $$lazyMap=this;
                    return e$434.getKey().equals(key$432);
                }),opt$433!==null?opt$433.getItem():null);
            };
            $$lazyMap.getIterator=function getIterator(){
                var $$lazyMap=this;
                return $$lazyMap.entries$431.getIterator();
            };
            $$lazyMap.equals=function equals(that$435){
                var $$lazyMap=this;
                var that$436;
                if(isOfType((that$436=that$435),{t:Map,a:{Key:{t:Object$},Item:{t:Object$}}})){
                    if(that$436.getSize().equals($$lazyMap.getSize())){
                        var it$437 = $$lazyMap.getIterator();
                        var entry$438;while ((entry$438=it$437.next())!==getFinished()){
                            var item$439;
                            if((item$439=that$436.get(entry$438.getKey()))!==null){
                                if(item$439.equals(entry$438.getItem())){
                                    continue;
                                }
                            }
                            return false;
                        }
                        if (getFinished() === entry$438){
                            return true;
                        }
                    }
                }
                ...
                var $$lazyMap=this;
                var hashCode$440=(1);
                var setHashCode$440=function(hashCode$441){return hashCode$440=hashCode$441;};
                var it$442 = $$lazyMap.entries$431.getIterator();
                var elem$443;while ((elem$443=it$442.next())!==getFinished()){
                    (hashCode$440=hashCode$440.times((31)));
                    (hashCode$440=hashCode$440.plus(elem$443.getHash()));
                }
                return hashCode$440;
            };
        })(LazyMap.$$.prototype);
...
$init$LazyMap();
var opt$433;
function LazySet(elems$444, $$targs$$,$$lazySet){
    $init$LazySet();
    if ($$lazySet===undefined)$$lazySet=new LazySet.$$;
    set_type_args($$lazySet,$$targs$$);
    $$lazySet.elems$444=elems$444;
    Set($$lazySet);
    return $$lazySet;
}
    ...
    if (LazySet.$$===undefined){
        ...
        (function($$lazySet){
            ...
            $$lazySet.getSize=function getSize(){
                var $$lazySet=this;
                var c$445=(0);
                var setC$445=function(c$446){return c$445=c$446;};
                var sorted$447=$$lazySet.elems$444.$sort(byIncreasing(function (e$448){
                    var $$lazySet=this;
                    return e$448.getHash();
                },{Value:{t:Integer},Element:$$lazySet.$$targs$$.Element}));
                var l$449;
                if((l$449=sorted$447.getFirst())!==null){
                    c$445=(1);
                    var last$450=l$449;
                    var setLast$450=function(last$451){return last$450=last$451;};
                    var it$452 = sorted$447.getRest().getIterator();
                    var e$453;while ((e$453=it$452.next())!==getFinished()){
                        if((!e$453.equals(last$450))){
                            (oldc$454=c$445,c$445=oldc$454.getSuccessor(),oldc$454);
                            var oldc$454;
                            last$450=e$453;
                        }
                    }
                ...
                var $$lazySet=this;
                return $$lazySet.elems$444.getIterator();
            };
            $$lazySet.union=function (set$455,$$$mptypes){
                var $$lazySet=this;
                return LazySet($$lazySet.elems$444.chain(set$455,{Other:$$$mptypes.Other}),{Element:{ t:'u', l:[$$lazySet.$$targs$$.Element,$$$mptypes.Other]}});
            };
            $$lazySet.intersection=function (set$456,$$$mptypes){
                var $$lazySet=this;
                return LazySet(Comprehension(function(){
                    var e$459;
                    var it$457=set$456.getIterator();
                    var e$458=getFinished();
                    var e$459;
                    var next$e$458=function(){
                        while((e$458=it$457.next())!==getFinished()){
                            if(isOfType((e$459=e$458),$$lazySet.$$targs$$.Element)&&$$lazySet.contains(e$459)){
                                return e$458;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$458();
                    return function(){
                        if(e$458!==getFinished()){
                            var e$458$460=e$458;
                            function getE$458(){return e$458$460;}
                            var tmpvar$461=e$459;
                            next$e$458();
                            return tmpvar$461;
                        }
                        return getFinished();
            ...
            $$lazySet.exclusiveUnion=function exclusiveUnion(other$462,$$$mptypes){
                var $$lazySet=this;
                var hereNotThere$463=Comprehension(function(){
                    var it$464=$$lazySet.elems$444.getIterator();
                    var e$465=getFinished();
                    var next$e$465=function(){
                        while((e$465=it$464.next())!==getFinished()){
                            if((!other$462.contains(e$465))){
                                return e$465;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$465();
                    return function(){
                        if(e$465!==getFinished()){
                            var e$465$466=e$465;
                            function getE$465(){return e$465$466;}
                            var tmpvar$467=getE$465();
                            next$e$465();
                            return tmpvar$467;
                        }
                        return getFinished();
                ...
                var thereNotHere$468=Comprehension(function(){
                    var it$469=other$462.getIterator();
                    var e$470=getFinished();
                    var next$e$470=function(){
                        while((e$470=it$469.next())!==getFinished()){
                            if((!$$lazySet.contains(e$470))){
                                return e$470;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$470();
                    return function(){
                        if(e$470!==getFinished()){
                            var e$470$471=e$470;
                            function getE$470(){return e$470$471;}
                            var tmpvar$472=getE$470();
                            next$e$470();
                            return tmpvar$472;
                        }
                        return getFinished();
                ...
                return LazySet(hereNotThere$463.chain(thereNotHere$468,{Other:$$$mptypes.Other}),{Element:{ t:'u', l:[$$lazySet.$$targs$$.Element,$$$mptypes.Other]}});
            };$$lazySet.complement=function (set$473,$$$mptypes){
                var $$lazySet=this;
                return LazySet(Comprehension(function(){
                    var it$474=$$lazySet.getIterator();
                    var e$475=getFinished();
                    var next$e$475=function(){
                        while((e$475=it$474.next())!==getFinished()){
                            if((!set$473.contains(e$475))){
                                return e$475;
                            }
                        }
                        return getFinished();
                    ...
                    next$e$475();
                    return function(){
                        if(e$475!==getFinished()){
                            var e$475$476=e$475;
                            function getE$475(){return e$475$476;}
                            var tmpvar$477=getE$475();
                            next$e$475();
                            return tmpvar$477;
                        }
                        return getFinished();
            ...
            $$lazySet.equals=function equals(that$478){
                var $$lazySet=this;
                var that$479;
                if(isOfType((that$479=that$478),{t:Set,a:{Element:{t:Object$}}})){
                    if(that$479.getSize().equals($$lazySet.getSize())){
                        var it$480 = $$lazySet.elems$444.getIterator();
                        var element$481;while ((element$481=it$480.next())!==getFinished()){
                            if((!that$479.contains(element$481))){
                                return false;
                            }
                        }
                        if (getFinished() === element$481){
                            return true;
                        }
                    }
                }
                ...
                var it$484 = $$lazySet.elems$444.getIterator();
                var elem$485;while ((elem$485=it$484.next())!==getFinished()){
                    (hashCode$482=hashCode$482.times((31)));
                    (hashCode$482=hashCode$482.plus(elem$485.getHash()));
                }
                return hashCode$482;
            };
        })(LazySet.$$.prototype);
...
function $init$Map(){
    if (Map.$$===undefined){
        ...
        (function($$map){
            $$map.equals=function equals(that$486){
                var $$map=this;
                var that$487;
                if(isOfType((that$487=that$486),{t:Map,a:{Key:{t:Object$},Item:{t:Object$}}})&&that$487.getSize().equals($$map.getSize())){
                    var it$488 = $$map.getIterator();
                    var entry$489;while ((entry$489=it$488.next())!==getFinished()){
                        var item$490;
                        if((item$490=that$487.get(entry$489.getKey()))!==null&&item$490.equals(entry$489.getItem())){
                            continue;
                        }else {
                            return false;
                        }
                    }
                    if (getFinished() === entry$489){
                        return true;
                    }
                }else {
                    return false;
                ...
                var $$map=this;
                var hashCode$491=(1);
                var setHashCode$491=function(hashCode$492){return hashCode$491=hashCode$492;};
                var it$493 = $$map.getIterator();
                var elem$494;while ((elem$494=it$493.next())!==getFinished()){
                    (hashCode$491=hashCode$491.times((31)));
                    (hashCode$491=hashCode$491.plus(elem$494.getHash()));
                }
                return hashCode$491;
            };$$map.getKeys=function getKeys(){
                var $$map=this;
                return LazySet(Comprehension(function(){
                    var it$495=$$map.getIterator();
                    var k$496,v$497;
                    var next$v$497=function(){
                        var entry$498;
                        if((entry$498=it$495.next())!==getFinished()){
                            k$496=entry$498.getKey();
                            v$497=entry$498.getItem();
                            return entry$498;
                        }
                        v$497=undefined;
                        return getFinished();
                    ...
                    return function(){
                        if(v$497!==undefined){
                            var k$496$499=k$496;
                            function getK$496(){return k$496$499;}
                            var v$497$500=v$497;
                            function getV$497(){return v$497$500;}
                            var tmpvar$501=getK$496();
                            next$v$497();
                            return tmpvar$501;
                        }
                        return getFinished();
            ...
            $$map.getValues=function getValues(){
                ...
                return LazyList(Comprehension(function(){
                    var it$502=$$map.getIterator();
                    var k$503,v$504;
                    var next$v$504=function(){
                        var entry$505;
                        if((entry$505=it$502.next())!==getFinished()){
                            k$503=entry$505.getKey();
                            v$504=entry$505.getItem();
                            return entry$505;
                        }
                        v$504=undefined;
                        return getFinished();
                    ...
                    return function(){
                        if(v$504!==undefined){
                            var k$503$506=k$503;
                            function getK$503(){return k$503$506;}
                            var v$504$507=v$504;
                            function getV$504(){return v$504$507;}
                            var tmpvar$508=getV$504();
                            next$v$504();
                            return tmpvar$508;
                        }
                        return getFinished();
            ...
            $$map.getInverse=function getInverse(){
                ...
                return LazyMap(Comprehension(function(){
                    var it$509=$$map.getIterator();
                    var key$510,item$511;
                    var next$item$511=function(){
                        var entry$512;
                        if((entry$512=it$509.next())!==getFinished()){
                            key$510=entry$512.getKey();
                            item$511=entry$512.getItem();
                            return entry$512;
                        }
                        item$511=undefined;
                        return getFinished();
                    ...
                    next$item$511();
                    return function(){
                        if(item$511!==undefined){
                            var key$510$513=key$510;
                            function getKey$510(){return key$510$513;}
                            var item$511$514=item$511;
                            function getItem$511(){return item$511$514;}
                            var tmpvar$515=Entry(getItem$511(),LazySet(Comprehension(function(){
                                var it$516=$$map.getIterator();
                                var k$517,i$518;
                                var next$i$518=function(){
                                    var entry$519;
                                    while((entry$519=it$516.next())!==getFinished()){
                                        k$517=entry$519.getKey();
                                        i$518=entry$519.getItem();
                                        if(i$518.equals(getItem$511())){
                                            return entry$519;
                                        }
                                    }
                                    i$518=undefined;
                                ...
                                return function(){
                                    if(i$518!==undefined){
                                        var k$517$520=k$517;
                                        function getK$517(){return k$517$520;}
                                        var i$518$521=i$518;
                                        function getI$518(){return i$518$521;}
                                        var tmpvar$522=getK$517();
                                        next$i$518();
                                        return tmpvar$522;
                                    }
                                    return getFinished();
            ...
            $$map.mapItems=function (mapping$523,$$$mptypes){
                var $$map=this;
                return LazyMap(Comprehension(function(){
                    var it$524=$$map.getIterator();
                    var key$525,item$526;
                    var next$item$526=function(){
                        var entry$527;
                        if((entry$527=it$524.next())!==getFinished()){
                            key$525=entry$527.getKey();
                            item$526=entry$527.getItem();
                            return entry$527;
                        }
                        item$526=undefined;
                        return getFinished();
                    ...
                    return function(){
                        if(item$526!==undefined){
                            ...
                            function getKey$525(){return key$525$528;}
                            var item$526$529=item$526;
                            function getItem$526(){return item$526$529;}
                            var tmpvar$530=Entry(getKey$525(),mapping$523(getKey$525(),getItem$526()),{Key:$$map.$$targs$$.Key,Item:$$$mptypes.Result});
                            next$item$526();
                            return tmpvar$530;
                        }
                        return getFinished();
...
$init$Map();
function any(values$531){
    var it$532 = values$531.getIterator();
    var val$533;while ((val$533=it$532.next())!==getFinished()){
        if(val$533){
            return true;
        }
    }
...
exports.any=any;
var byDecreasing=function (comparable$534,$$$mptypes){
    return function(x$535,y$536){{
        return comparable$534(y$536).compare(comparable$534(x$535));
    }
}
}
;
exports.byDecreasing=byDecreasing;
var byIncreasing=function (comparable$537,$$$mptypes){
    return function(x$538,y$539){{
        return comparable$537(x$538).compare(comparable$537(y$539));
    }
}
}
;
exports.byIncreasing=byIncreasing;
var byItem=function (comparing$540,$$$mptypes){
    return function(x$541,y$542){{
        return comparing$540(x$541.getItem(),y$542.getItem());
    }
}
}
;
exports.byItem=byItem;
var byKey=function (comparing$543,$$$mptypes){
    return function(x$544,y$545){{
        return comparing$543(x$544.getKey(),y$545.getKey());
    }
}
}
;
exports.byKey=byKey;
var coalesce=function (values$546,$$$mptypes){
    return values$546.getCoalesced();
};
exports.coalesce=coalesce;
function count(values$547){
    var count$548=(0);
    var setCount$548=function(count$549){return count$548=count$549;};
    var it$550 = values$547.getIterator();
    var val$551;while ((val$551=it$550.next())!==getFinished()){
        if(val$551){
            (oldcount$552=count$548,count$548=oldcount$552.getSuccessor(),oldcount$552);
            var oldcount$552;
        }
    }
    return count$548;
...
exports.count=count;
var curry=function (f$553,$$$mptypes){
    return function(first$554){{
        return flatten(function (args$555){
            return unflatten(f$553,{Args:{t:Tuple,a:{Rest:$$$mptypes.Rest,First:$$$mptypes.First,Element:$$$mptypes.Argument}},Return:$$$mptypes.Return})(Tuple(first$554,args$555,{Rest:$$$mptypes.Rest,First:$$$mptypes.First,Element:$$$mptypes.Argument}));
...
;
exports.curry=curry;
var uncurry=function (f$556,$$$mptypes){
return flatten(function (args$557){
    return unflatten(f$556(args$557.getFirst()),{Args:$$$mptypes.Rest,Return:$$$mptypes.Return})(args$557.getRest());
},{Args:{t:Tuple,a:{Rest:$$$mptypes.Rest,First:$$$mptypes.First,Element:$$$mptypes.Argument}},Return:$$$mptypes.Return});
};
exports.uncurry=uncurry;
function emptyOrSingleton(element$558,$$$mptypes){
    var element$559;
    if((element$559=element$558)!==null){
        return Singleton(element$559,{Element:$$$mptypes.Element});
    }else {
        return getEmpty();
    }
}
exports.emptyOrSingleton=emptyOrSingleton;
var entries=function (elements$560,$$$mptypes){
    return elements$560.getIndexed();
};
exports.entries=entries;
var equalTo=function (val$561,$$$mptypes){
    return function(element$562){{
        return element$562.equals(val$561);
    }
}
}
;
exports.equalTo=equalTo;
function every(values$563){
    var it$564 = values$563.getIterator();
    var val$565;while ((val$565=it$564.next())!==getFinished()){
        if((!val$565)){
            return false;
        }
    }
...
exports.every=every;
var first=function (values$566,$$$mptypes){
    return internalFirst(values$566,{Value:$$$mptypes.Value,Absent:$$$mptypes.Absent});
};
exports.first=first;
var forItem=function (resulting$567,$$$mptypes){
    return function(entry$568){{
        return resulting$567(entry$568.getItem());
    }
}
}
;
exports.forItem=forItem;
var forKey=function (resulting$569,$$$mptypes){
    return function(entry$570){{
        return resulting$569(entry$570.getKey());
    }
}
}
;
exports.forKey=forKey;
var greaterThan=function (val$571,$$$mptypes){
    return function(element$572){{
        return element$572.compare(val$571).equals(getLarger());
    }
}
}
;
exports.greaterThan=greaterThan;
var join=function (iterables$573,$$$mptypes){
    if(iterables$573===undefined){iterables$573=getEmpty();}
    return Comprehension(function(){
        var it$574=iterables$573.getIterator();
        var it$575=getFinished();
        var next$it$575=function(){
            if((it$575=it$574.next())!==getFinished()){
                it$576=it$575.getIterator();
                next$val$577();
                return it$575;
            }
            return getFinished();
        ...
        var it$576;
        var val$577=getFinished();
        var next$val$577=function(){return val$577=it$576.next();}
        next$it$575();
        return function(){
            do{
                if(val$577!==getFinished()){
                    var val$577$578=val$577;
                    function getVal$577(){return val$577$578;}
                    var tmpvar$579=getVal$577();
                    next$val$577();
                    return tmpvar$579;
                }
            }while(next$it$575()!==getFinished());
            return getFinished();
        }
    },{Absent:{t:Anything},Element:$$$mptypes.Element}).getSequence();
};
exports.join=join;
var largest=function (x$580,y$581,$$$mptypes){
    return (opt$582=(x$580.compare(y$581).equals(getLarger())?x$580:null),opt$582!==null?opt$582:y$581);
};
exports.largest=largest;
var opt$582;
var lessThan=function (val$583,$$$mptypes){
    return function(element$584){{
        return element$584.compare(val$583).equals(getSmaller());
    }
}
}
;
exports.lessThan=lessThan;
function max(values$585,$$$mptypes){
    var first$586=values$585.getFirst();
    var first$587;
    if((first$587=first$586)!==null){
        var max$588=first$587;
        var setMax$588=function(max$589){return max$588=max$589;};
        var it$590 = values$585.getRest().getIterator();
        var val$591;while ((val$591=it$590.next())!==getFinished()){
            if(val$591.compare(max$588).equals(getLarger())){
                max$588=val$591;
            }
        }
        return max$588;
...
exports.max=max;
function min(values$592,$$$mptypes){
    var first$593=values$592.getFirst();
    var first$594;
    if((first$594=first$593)!==null){
        var min$595=first$594;
        var setMin$595=function(min$596){return min$595=min$596;};
        var it$597 = values$592.getRest().getIterator();
        var val$598;while ((val$598=it$597.next())!==getFinished()){
            if(val$598.compare(min$595).equals(getSmaller())){
                min$595=val$598;
            }
        }
        return min$595;
...
function print(line$599){
    getProcess().writeLine((opt$600=(opt$601=line$599,opt$601!==null?opt$601.getString():null),opt$600!==null?opt$600:String$("«null»",6)));
    var opt$600,opt$601;
}
exports.print=print;
function product(values$602,$$$mptypes){
    var product$603=values$602.getFirst();
    var setProduct$603=function(product$604){return product$603=product$604;};
    var it$605 = values$602.getRest().getIterator();
    var val$606;while ((val$606=it$605.next())!==getFinished()){
        (product$603=product$603.times(val$606));
    }
    return product$603;
}
exports.product=product;
var smallest=function (x$607,y$608,$$$mptypes){
    return (opt$609=(x$607.compare(y$608).equals(getSmaller())?x$607:null),opt$609!==null?opt$609:y$608);
};
exports.smallest=smallest;
var opt$609;
function sum(values$610,$$$mptypes){
    var sum$611=values$610.getFirst();
    var setSum$611=function(sum$612){return sum$611=sum$612;};
    var it$613 = values$610.getRest().getIterator();
    var val$614;while ((val$614=it$613.next())!==getFinished()){
        (sum$611=sum$611.plus(val$614));
    }
    return sum$611;
}
exports.sum=sum;
function zip(keys$615,items$616,$$$mptypes){
    var iter$617=items$616.getIterator();
    return Comprehension(function(){
        var item$620;
        var it$618=keys$615.getIterator();
        var key$619=getFinished();
        var item$620;
        var next$key$619=function(){
            while((key$619=it$618.next())!==getFinished()){
                if(!isOfType((item$620=iter$617.next()),{t:Finished})){
                    return key$619;
                }
            }
            return getFinished();
        ...
        next$key$619();
        return function(){
            if(key$619!==getFinished()){
                var key$619$621=key$619;
                function getKey$619(){return key$619$621;}
                var tmpvar$622=Entry(getKey$619(),item$620,{Key:$$$mptypes.Key,Item:$$$mptypes.Item});
                next$key$619();
                return tmpvar$622;
            }
            return getFinished();
...
exports.zip=zip;
function combine(combination$623,elements$624,otherElements$625,$$$mptypes){
    function CombineIterable$626($$combineIterable$626){
        $init$CombineIterable$626();
        if ($$combineIterable$626===undefined)$$combineIterable$626=new CombineIterable$626.$$;
        $$combineIterable$626.$$targs$$={Absent:$$$mptypes.Absent,Element:$$$mptypes.Result};
        Iterable($$combineIterable$626);
        return $$combineIterable$626;
    }
    function $init$CombineIterable$626(){
        if (CombineIterable$626.$$===undefined){
            initTypeProto(CombineIterable$626,'ceylon.language::combine.CombineIterable',Basic,$init$Iterable());
            (function($$combineIterable$626){
                $$combineIterable$626.getIterator=function getIterator(){
                    var $$combineIterable$626=this;
                    function CombineIterator$627($$combineIterator$627){
                        $init$CombineIterator$627();
                        if ($$combineIterator$627===undefined)$$combineIterator$627=new CombineIterator$627.$$;
                        $$combineIterator$627.$$targs$$={Element:$$$mptypes.Result};
                        Iterator($$combineIterator$627);
                        $$combineIterator$627.iter$628=elements$624.getIterator();
                        $$combineIterator$627.otherIter$629=otherElements$625.getIterator();
                        return $$combineIterator$627;
                    }
                    function $init$CombineIterator$627(){
                        if (CombineIterator$627.$$===undefined){
                            initTypeProto(CombineIterator$627,'ceylon.language::combine.CombineIterable.iterator.CombineIterator',Basic,$init$Iterator());
                            (function($$combineIterator$627){
                                $$combineIterator$627.getIter$628=function getIter$628(){
                                    return this.iter$628;
                                };
                                $$combineIterator$627.getOtherIter$629=function getOtherIter$629(){
                                    return this.otherIter$629;
                                };
                                $$combineIterator$627.next=function next(){
                                    var $$combineIterator$627=this;
                                    var elem$630=$$combineIterator$627.getIter$628().next();
                                    var otherElem$631=$$combineIterator$627.getOtherIter$629().next();
                                    var elem$632;
                                    var otherElem$633;
                                    if(!isOfType((elem$632=elem$630),{t:Finished})&&!isOfType((otherElem$633=otherElem$631),{t:Finished})){
                                        return combination$623(elem$632,otherElem$633);
                                    }else {
                                        return getFinished();
                                    }
                                };
                            })(CombineIterator$627.$$.prototype);
                        }
                        return CombineIterator$627;
                    }
                    $init$CombineIterator$627();
...
var compose=function (x$634,y$635,$$$mptypes){
    return flatten(function (args$636){
        return x$634(unflatten(y$635,{Args:$$$mptypes.Args,Return:$$$mptypes.Y})(args$636));
    },{Args:$$$mptypes.Args,Return:$$$mptypes.X});
};
exports.compose=compose;
var identical=function (x$637,y$638){
    return (x$637===y$638);
};
exports.identical=identical;
function internalFirst(values$639,$$$mptypes){
    var first$640;
    var next$641;
    if(!isOfType((next$641=values$639.getIterator().next()),{t:Finished})){
        first$640=next$641;
    }else {
        first$640=null;
    }
    ...
    var first$642;
    if (!(isOfType((first$642=first$640),{ t:'u', l:[$$$mptypes.Absent,$$$mptypes.Value]}))) { throw AssertionException('Assertion failed: \'is Absent|Value first\' at internalFirst.ceylon (10:11-10:33)'); }
    return first$642;
}
exports.internalFirst=internalFirst;
var plus=function (x$643,y$644,$$$mptypes){
    return x$643.plus(y$644);
};
exports.plus=plus;
var shuffle=function (f$645,$$$mptypes){
    return flatten(function (secondArgs$646){
        return flatten(function (firstArgs$647){
            return unflatten(unflatten(f$645,{Args:$$$mptypes.FirstArgs,Return:{t:Callable,a:{Arguments:$$$mptypes.SecondArgs,Return:$$$mptypes.Result}}})(firstArgs$647),{Args:$$$mptypes.SecondArgs,Return:$$$mptypes.Result})(secondArgs$646);
...
var sort=function (elements$648,$$$mptypes){
    return internalSort(byIncreasing(function (e$649){
        return e$649;
    },{Value:$$$mptypes.Element,Element:$$$mptypes.Element}),elements$648,{Element:$$$mptypes.Element});
};
exports.sort=sort;
var times=function (x$650,y$651,$$$mptypes){
    return x$650.times(y$651);
};
exports.times=times;
